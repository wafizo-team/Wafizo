    ...
    <div className="min-h-screen bg-[#FAF8F3] text-[#16213E]">
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-12 px-6 py-16 md:grid-cols-2 md:py-24">
        <div>
          <h1 className="font-['Bricolage_Grotesque'] text-4xl font-extrabold leading-[1.1] md:text-5xl">
            Répondez à vos avis Google en <span className="text-[#E0A63A]">30 secondes</span>, pas
            en 30 minutes
          </h1>

          <p className="mt-5 font-['Inter'] text-lg leading-relaxed text-[#16213E]/70">
            Wafizo génère des réponses professionnelles à vos avis clients, en un clic. Fait pour le
            commerçant qui gère sa fiche seul — pas pour les groupes à 50 établissements.
          </p>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mt-8 grid gap-10 md:grid-cols-3">
            <div>
              <span className="font-['IBM_Plex_Mono',monospace] text-sm text-[#E0A63A]">01</span>
              ...
              <p className="mt-2 font-['Inter'] text-sm leading-relaxed text-[#16213E]/60">
                Reliez votre Google Business Profile en deux minutes. Pas de démo, pas d'onboarding.
              </p>
            </div>

            <div>
              <span className="font-['IBM_Plex_Mono',monospace] text-sm text-[#E0A63A]">02</span>
              ...
              <p className="mt-2 font-['Inter'] text-sm leading-relaxed text-[#16213E]/60">
                Une réponse professionnelle et personnalisée, générée en un clic.
              </p>
            </div>

            <div>
              <span className="font-['IBM_Plex_Mono',monospace] text-sm text-[#E0A63A]">03</span>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <p className="mt-2 max-w-2xl font-['Inter'] leading-relaxed text-[#16213E]/60">
          Les autres outils sont pensés pour des chaînes et des groupes. Wafizo est pensé pour un
          commerce, une fiche Google, une app simple.
        </p>
      ...
      <footer className="border-t border-[#E3DED2] py-8">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 font-['Inter'] text-xs text-[#16213E]/40 md:flex-row">
          ...
          <div className="flex gap-4">
            <a href="/mentions-legales" className="transition hover:text-[#16213E]">
              Mentions légales
            </a>

            <a href="/confidentialite" className="transition hover:text-[#16213E]">
              Confidentialité
            </a>
          </div>
        </div>
